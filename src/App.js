  ...
  return (
    <div className="body">
      ...
      <main>
        <Home/>
        <Fade direction="up">
        <div className="flex items-center justify-center h-screen bg-fuchsia-900 m-7 rounded-3xl" id='about'>
              <h1>about</h1>
          </div>
          ...
          <div className="flex items-center justify-center h-screen bg-fuchsia-900 m-7 rounded-3xl" id='contact me'>
              <h1>contact me</h1>
          </div>
